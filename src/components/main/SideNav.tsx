...
import { sideNavArrowLeftBtn } from "../../assets/svgs";
import { sideNavArrowRightBtn } from "../../assets/svgs";
import { useState } from "react";

const SideNav = () => {
  const [showSideNavBody, setShowSideNavBody] = useState(false);
  ...
  return (
    <div className="side-nav__container">
      <button
        ...
        style={{ right: showSideNavBody ? '228px' : '22px' }}
        onClick={() => setShowSideNavBody(!showSideNavBody)}
      >
        <img
          src={showSideNavBody ? sideNavArrowRightBtn : sideNavArrowLeftBtn}
          alt="hamburger"
